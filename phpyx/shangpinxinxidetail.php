...
<table width="98%" border="0"  align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse" class="newsline"> 
    ...
    <td width='11%' height=44>CDK：</td><td width='39%'>********</td></tr><tr>
...
<tr><td colspan=3 align=center><input type=button name=Submit53 class='hsgqiehuanshitu' value=购买 onClick="javascript:location.href='goumaijiluadd.php?id=<?php echo $_GET["id"];?>';"  /> <!--jixaaxnnxiu--><input type=button name=Submit53 value=评论 onClick="javascript:OpenScript('hsgpinglun.php?biao=shangpinxinxi&id=<?php echo $id;?>',500,200)" class='hsgqiehuanshitu'  /></td></tr>
