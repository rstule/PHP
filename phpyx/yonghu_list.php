	...
	for($i=$pagecurrent*$pagelarge-$pagelarge;$i<$ddddd;$i++)
{
  ...
  <tr>
	...
	<a class="btn btn-warning" href="yonghu_updt.php?id=<?php echo mysql_result($query,$i,"id");?>"><i class="mdi mdi-delete-empty"></i> 修改</a> <a class='btn btn-info' href="yonghudetail.php?id=<?php echo mysql_result($query,$i,"id");?>" target="_blank"><i class='mdi mdi-arrow-expand-all'></i> 详细</a> </td>
  </tr>
  	<?php
	}
}
