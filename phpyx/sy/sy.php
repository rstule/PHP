		...
		<div class="col-md-5" style="margin:auto">
			<div class="cal1 cal_2">
				<div class="clndr">
					...
					<table height="500"  cellpadding="0" cellspacing="0" class="clndr-table">
						<thead>
			...
			<link rel="stylesheet" href="images/css/clndr.css" type="text/css" />
			<script src="images/js/underscore-min.js" type="text/javascript"></script>
			<script src="images/js/moment-2.2.1.js" type="text/javascript"></script>
			<script src="images/js/clndr.js" type="text/javascript"></script>
			<script src="images/js/site.js" type="text/javascript"></script>
		</div>
	</div>
</body>
