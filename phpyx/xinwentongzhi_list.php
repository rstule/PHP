...
<body>
 <div class="card">
              <div class="card-header"><h4><?php echo $lb;?>列表</h4></div>
              <div class="card-body">
			   <form class="form-inline" action="" method="post">
                  <div class="form-group">
                     <input name="biaoti" type="text" id="biaoti" class="form-control" placeholder="请输入标题.." /> 
                  </div>
                  <div class="form-group">
	...
	for($i=$pagecurrent*$pagelarge-$pagelarge;$i<$ddddd;$i++)
{
  ...
  <tr>
	...
	<a class="btn btn-warning" href="xinwentongzhi_updt.php?id=<?php echo mysql_result($query,$i,"id");?>"><i class="mdi mdi-delete-empty"></i> 修改</a> <a class='btn btn-info' href="gg_detail.php?id=<?php echo mysql_result($query,$i,"id");?>" target="_blank"><i class='mdi mdi-arrow-expand-all'></i> 详细</a> </td>
  </tr>
  	<?php
	}
}
