...
if ($addnew=="1" )
{
	...
	$sql="update yonghu set zhanghao='$zhanghao',mima='$mima',xingming='$xingming',xingbie='$xingbie',shouji='$shouji',shenfenzheng='$shenfenzheng',zhaopian='$zhaopian',beizhu='$beizhu' where zhanghao= '".$_SESSION["username"]."'";
	mysql_query($sql);
...
<body>
<?php
$sql="select * from yonghu where zhanghao='".$_SESSION["username"]."'";
...
?>
<div >
              <div class="card-header"><h4>修改个人资料</h4></div>
              <div class="card-body">
