	...
	function check()
{
    ...
    if((/^[0-9]+.?[0-9]*$/.test(document.form1.jiage.value))){}else{$.alert("价格必需数字型");document.form1.jiage.focus();return false;}
    if(document.form1.kucun.value==""){$.alert("请输入库存");document.form1.kucun.focus();return false;}
    if((/^[0-9]+.?[0-9]*$/.test(document.form1.kucun.value))){}else{$.alert("库存必需数字型");document.form1.kucun.focus();return false;}
...
<div >
              <div class="card-header"><h4>商品信息添加</h4></div>
              <div class="card-body">
                <form class="form-horizontal" action="?id=<?php echo $_GET["id"]?>" method="post" id="form1" name="form1" onSubmit="return check();"><input type="hidden" name="addnew" value="1" />
                 <div class='form-group'><label class='col-md-3 control-label'>商品编号</label><div class='col-md-7'><input type='text' class='form-control' value='<?php echo makefilename2()?>' name='shangpinbianhao' id='shangpinbianhao' style='width:45%' placeholder='请输入商品编号' /></div></div>
    <div class='form-group'><label class='col-md-3 control-label'>商品名称</label><div class='col-md-7'><input type='text' class='form-control' value='' name='shangpinmingcheng' id='shangpinmingcheng' style='width:45%' placeholder='请输入商品名称' /></div></div>
    <div class='form-group'><label class='col-md-3 control-label'>价格</label><div class='col-md-7'><input type='text' class='form-control' value='' name='jiage' id='jiage' style='width:45%' placeholder='请输入价格' /></div></div>
    <div class='form-group'><label class='col-md-3 control-label'>库存</label><div class='col-md-7'><input type='text' class='form-control' value='' name='kucun' id='kucun' style='width:45%' placeholder='请输入库存' /></div></div>
    <div class='form-group'><label class='col-md-3 control-label'>销量</label><div class='col-md-7'><input type='text' class='form-control' value='' name='xiaoliang' id='xiaoliang' style='width:45%' placeholder='请输入销量' /></div></div>
    <div class='form-group'><label class='col-md-3 control-label'>CDK</label><div class='col-md-7'><input type='text' class='form-control' value='BGRBZBZG3K' name='CDK' id='CDK' style='width:45%' placeholder='请输入CDK' />
    </div></div>
    <div class='form-group'><label class='col-md-3 control-label'>图片</label><div class='col-md-7'><input name='tupian' type='text' id='tupian' data-place='right' class='form-control'  style='width:75%; float:left;'/>&nbsp;<input type='button' name='Submit2' class='btn btn-primary' value='上传' onClick="javaScript:OpenScript('upfile.php?Result=tupian',600,500)" /></div></div>
