	...
	for($i=$pagecurrent*$pagelarge-$pagelarge;$i<$ddddd;$i++)
{
  ...
  <tr>
	...
	<a class="btn btn-warning" href="dingdanxinxi_updt.php?id=<?php echo mysql_result($query,$i,"id");?>"><i class="mdi mdi-delete-empty"></i> 修改</a> <a class='btn btn-info' href="dingdanxinxidetail.php?id=<?php echo mysql_result($query,$i,"id");?>" target="_blank"><i class='mdi mdi-arrow-expand-all'></i> 详细</a> </td>
  </tr>
  	<?php
	}
}
?>
 ...
 <nav>
	 ...
	 ?>
					>
                      <a href="dingdanxinxi_list.php?pagecurrent=<?php echo $t;?>">
	 ...
	 ?>><a href="dingdanxinxi_list.php?pagecurrent=<?php echo $fyi;?>"><?php echo $fyi;?></a></li>
					 <?php
	 }
	 ?>
                    <li>
                      <a href="dingdanxinxi_list.php?pagecurrent=<?php echo $pagecurrent+1;?>">
