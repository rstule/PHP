...
?>
 ...
 <nav>
	 ...
	 ?>
					>
                      <a href="goumaijilu_list2.php?pagecurrent=<?php echo $t;?>">
	 ...
	 ?>><a href="goumaijilu_list2.php?pagecurrent=<?php echo $fyi;?>"><?php echo $fyi;?></a></li>
					 <?php
	 }
	 ?>
                    <li>
                      <a href="goumaijilu_list2.php?pagecurrent=<?php echo $pagecurrent+1;?>">
                        <span><i class="mdi mdi-chevron-right"></i></span>
                      </a>
                    </li>
                  </ul>
                </nav><input type="button"name="Submit22"onclick="javascript:location.href='dingdanxinxi_add.php';" value="生成订单" style='border:solid 1px #000000; color:#666666' />
		<p>以上数据共<?php echo $rowscount;?>条,共计总购买金额:<?php echo $goumaijinez?>； </p>		
