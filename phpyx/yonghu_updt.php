...
if ($addnew=="1" )
{
	...
	$sql="update yonghu set zhanghao='$zhanghao',mima='$mima',xingming='$xingming',xingbie='$xingbie',shouji='$shouji',shenfenzheng='$shenfenzheng',zhaopian='$zhaopian',beizhu='$beizhu' where id= ".$id;
	mysql_query($sql);
